...
namespace coreneuron {
    ...
    static Exp2Syn_Store Exp2Syn_global;
    ...
    static inline void copy_instance_to_device(NrnThread* nt, Memb_list* ml, Exp2Syn_Instance const* inst);
    static inline void delete_instance_from_device(Exp2Syn_Instance* inst);
    ...
    static inline void copy_instance_to_device(NrnThread* nt, Memb_list* ml, Exp2Syn_Instance const* inst) {
        ...
        tmp.tau2 = cnrn_target_deviceptr(tmp.tau2);
        ...
        tmp.factor = cnrn_target_deviceptr(tmp.factor);
