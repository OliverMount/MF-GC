...
namespace coreneuron {
    ...
    static ExpSyn_Store ExpSyn_global;
    ...
    static inline void copy_instance_to_device(NrnThread* nt, Memb_list* ml, ExpSyn_Instance const* inst);
    static inline void delete_instance_from_device(ExpSyn_Instance* inst);
    ...
    static inline void copy_instance_to_device(NrnThread* nt, Memb_list* ml, ExpSyn_Instance const* inst) {
        ...
        tmp.Dg = cnrn_target_deviceptr(tmp.Dg);
