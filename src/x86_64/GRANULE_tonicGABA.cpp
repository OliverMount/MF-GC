...
#define nrn_init _nrn_init__GrCtonicGABA
#define _nrn_initial _nrn_initial__GrCtonicGABA
#define nrn_cur _nrn_cur__GrCtonicGABA
#define _nrn_current _nrn_current__GrCtonicGABA
#define nrn_jacob _nrn_jacob__GrCtonicGABA
#define nrn_state _nrn_state__GrCtonicGABA
#define _net_receive _net_receive__GrCtonicGABA 
...
#define t _nt->_t
#define dt _nt->_dt
#define e _ml->template fpfield<0>(_iml)
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 2, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 5);
 	...
 	e = _parm_default[0]; /* -75 */
 	g = _parm_default[1]; /* 0.00026 */
  }
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 5);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _GRANULE_tonicGABA_reg() {
	int _vectorized = 1;
  _initlists();
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 GrCtonicGABA /home/oliver/GranularLayerModel/src/mod/GRANULE_tonicGABA.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/oliver/GranularLayerModel/src/mod/GRANULE_tonicGABA.mod";
