...
#define el _ml->template fpfield<2>(_iml)
#define el_columnindex 2
#define fix_celsius _ml->template fpfield<3>(_iml)
#define fix_celsius_columnindex 3
#define il _ml->template fpfield<4>(_iml)
#define il_columnindex 4
#define g _ml->template fpfield<5>(_iml)
#define g_columnindex 5
#define gbar_Q10 _ml->template fpfield<6>(_iml)
#define gbar_Q10_columnindex 6
...
static void nrn_alloc(Prop* _prop) {
  ...
  Datum *_ppvar{};
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 9);
 	...
 	gbar = _parm_default[0]; /* 5.68e-05 */
 	Q10_diff = _parm_default[1]; /* 1.5 */
 	el = _parm_default[2]; /* 0 */
 	fix_celsius = _parm_default[3]; /* 37 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 9);
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _GRANULE_LKG1_reg() {
	int _vectorized = 1;
  _initlists();
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"el"} /* 2 */,
                                       _nrn_mechanism_field<double>{"fix_celsius"} /* 3 */,
                                       _nrn_mechanism_field<double>{"il"} /* 4 */,
                                       _nrn_mechanism_field<double>{"g"} /* 5 */,
                                       _nrn_mechanism_field<double>{"gbar_Q10"} /* 6 */,
                                       _nrn_mechanism_field<double>{"v"} /* 7 */,
                                       _nrn_mechanism_field<double>{"_g"} /* 8 */);
  hoc_register_prop_size(_mechtype, 9, 0);
 
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 GRANULE_LKG1 /home/oliver/GranularLayerModel/src/mod/GRANULE_LKG1.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/oliver/GranularLayerModel/src/mod/GRANULE_LKG1.mod";
