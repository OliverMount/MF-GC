...
#define gbar _ml->template fpfield<6>(_iml)
#define gbar_columnindex 6
#define Q10_diff _ml->template fpfield<7>(_iml)
#define Q10_diff_columnindex 7
#define Q10_channel _ml->template fpfield<8>(_iml)
#define Q10_channel_columnindex 8
...
#define n_inf _ml->template fpfield<11>(_iml)
#define n_inf_columnindex 11
#define tau_n _ml->template fpfield<12>(_iml)
#define tau_n_columnindex 12
#define g _ml->template fpfield<13>(_iml)
#define g_columnindex 13
#define gbar_Q10 _ml->template fpfield<14>(_iml)
#define gbar_Q10_columnindex 14
...
#define ik _ml->template fpfield<18>(_iml)
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 4, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 21);
 	...
 	Aalpha_n = _parm_default[0]; /* -0.01 */
 	Kalpha_n = _parm_default[1]; /* -10 */
 	V0alpha_n = _parm_default[2]; /* -25 */
 	Abeta_n = _parm_default[3]; /* 0.125 */
 	Kbeta_n = _parm_default[4]; /* -80 */
 	V0beta_n = _parm_default[5]; /* -35 */
 	gbar = _parm_default[6]; /* 0.003 */
 	Q10_diff = _parm_default[7]; /* 1.5 */
 	Q10_channel = _parm_default[8]; /* 3 */
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"gbar"} /* 6 */,
                                       _nrn_mechanism_field<double>{"Q10_diff"} /* 7 */,
                                       _nrn_mechanism_field<double>{"Q10_channel"} /* 8 */,
                                       _nrn_mechanism_field<double>{"fix_celsius"} /* 9 */,
                                       _nrn_mechanism_field<double>{"ic"} /* 10 */,
                                       _nrn_mechanism_field<double>{"n_inf"} /* 11 */,
                                       _nrn_mechanism_field<double>{"tau_n"} /* 12 */,
                                       _nrn_mechanism_field<double>{"g"} /* 13 */,
                                       _nrn_mechanism_field<double>{"gbar_Q10"} /* 14 */,
                                       _nrn_mechanism_field<double>{"n"} /* 15 */,
                                       _nrn_mechanism_field<double>{"ek"} /* 16 */,
                                       _nrn_mechanism_field<double>{"Dn"} /* 17 */,
                                       _nrn_mechanism_field<double>{"ik"} /* 18 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 GRANULE_KV /home/oliver/GranularLayerModel/src/mod/GRANULE_KV.mod\n");
...
double alp_n ( _internalthreadargsprotocomma_ double _lv ) {
   double _lalp_n;
 double _lQ10 ;
 _lQ10 = pow( Q10_channel , ( ( fix_celsius - 6.3 ) / 10.0 ) ) ;
...
static void _hoc_alp_n(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for alp_n_GRANULE_KV. Requires prior call to setdata_GRANULE_KV and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void _hoc_bet_n(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for bet_n_GRANULE_KV. Requires prior call to setdata_GRANULE_KV and that the specified mechanism instance still be in existence.", NULL);
  }
  Prop* _local_prop = _extcall_prop;
  _nrn_mechanism_cache_instance _ml_real{_local_prop};
auto* const _ml = &_ml_real;
...
static void _hoc_rate(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rate_GRANULE_KV. Requires prior call to setdata_GRANULE_KV and that the specified mechanism instance still be in existence.", NULL);
  }
  Prop* _local_prop = _extcall_prop;
  _nrn_mechanism_cache_instance _ml_real{_local_prop};
auto* const _ml = &_ml_real;
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/oliver/GranularLayerModel/src/mod/GRANULE_KV.mod";
