...
#define t _nt->_t
#define dt _nt->_dt
#define ic _ml->template fpfield<0>(_iml)
#define ic_columnindex 0
#define d _ml->template fpfield<1>(_iml)
#define d_columnindex 1
...
#define beta _ml->template fpfield<4>(_iml)
#define beta_columnindex 4
#define fix_celsius _ml->template fpfield<5>(_iml)
#define fix_celsius_columnindex 5
#define beta_Q10 _ml->template fpfield<6>(_iml)
#define beta_Q10_columnindex 6
...
#define tau _ml->template fpfield<9>(_iml)
#define tau_columnindex 9
#define cai _ml->template fpfield<10>(_iml)
#define cai_columnindex 10
#define Dcai _ml->template fpfield<11>(_iml)
#define Dcai_columnindex 11
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 6, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 14);
 	...
 	ic = _parm_default[0]; /* 0 */
 	d = _parm_default[1]; /* 0.2 */
 	cai0 = _parm_default[2]; /* 0.0001 */
 	Q10_diff = _parm_default[3]; /* 3 */
 	beta = _parm_default[4]; /* 1.5 */
 	fix_celsius = _parm_default[5]; /* 37 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 14);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _GRANULE_CALC_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("ca", -10000.);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"ic"} /* 0 */,
                                       _nrn_mechanism_field<double>{"d"} /* 1 */,
                                       _nrn_mechanism_field<double>{"cai0"} /* 2 */,
                                       _nrn_mechanism_field<double>{"Q10_diff"} /* 3 */,
                                       _nrn_mechanism_field<double>{"beta"} /* 4 */,
                                       _nrn_mechanism_field<double>{"fix_celsius"} /* 5 */,
                                       _nrn_mechanism_field<double>{"beta_Q10"} /* 6 */,
                                       _nrn_mechanism_field<double>{"ica"} /* 7 */,
                                       _nrn_mechanism_field<double>{"cao"} /* 8 */,
                                       _nrn_mechanism_field<double>{"tau"} /* 9 */,
                                       _nrn_mechanism_field<double>{"cai"} /* 10 */,
                                       _nrn_mechanism_field<double>{"Dcai"} /* 11 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 GRANULE_CALC /home/oliver/GranularLayerModel/src/mod/GRANULE_CALC.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (_internalthreadargsproto_) {int _reset = 0; {
   Dcai = - ica / tau - beta_Q10 * ( cai - cai0 ) ;
   }
 return _reset;
}
 static int _ode_matsol1 (_internalthreadargsproto_) {
...
static void initmodel(_internalthreadargsproto_) {
  int _i; double _save;{
 {
   beta_Q10 = beta * ( pow( Q10_diff , ( ( fix_celsius - 30.0 ) / 10.0 ) ) ) ;
   cai = cai0 ;
   tau = ( 2.0 * F * d ) / ( 1e4 ) ;
   }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/oliver/GranularLayerModel/src/mod/GRANULE_CALC.mod";
