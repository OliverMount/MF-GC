...
#define nrn_init _nrn_init__GRANULE_Nmda_leak_linear
#define _nrn_initial _nrn_initial__GRANULE_Nmda_leak_linear
#define nrn_cur _nrn_cur__GRANULE_Nmda_leak_linear
#define _nrn_current _nrn_current__GRANULE_Nmda_leak_linear
#define nrn_jacob _nrn_jacob__GRANULE_Nmda_leak_linear
#define nrn_state _nrn_state__GRANULE_Nmda_leak_linear
#define _net_receive _net_receive__GRANULE_Nmda_leak_linear 
#define _f_rates _f_rates__GRANULE_Nmda_leak_linear 
#define rates rates__GRANULE_Nmda_leak_linear 
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_GRANULE_Nmda_leak_linear", _hoc_setdata},
 {"rates_GRANULE_Nmda_leak_linear", _hoc_rates},
 {0, 0}
};
...
static NPyDirectMechFunc npy_direct_func_proc[] = {
 ...
 #define gind 0
 #define _gth 0
#define Or Or_GRANULE_Nmda_leak_linear
 double Or = 52;
#define O O_GRANULE_Nmda_leak_linear
 double O = 0.01;
#define deltav deltav_GRANULE_Nmda_leak_linear
 double deltav = 22.4;
#define kmg kmg_GRANULE_Nmda_leak_linear
 double kmg = 1.77;
#define mgo mgo_GRANULE_Nmda_leak_linear
 double mgo = 1;
#define surf surf_GRANULE_Nmda_leak_linear
 double surf = 2.9926e-06;
#define usetable usetable_GRANULE_Nmda_leak_linear
 double usetable = 1;
...
static void _check_table_thread(_threadargsprotocomma_ int _type, _nrn_model_sorted_token const& _sorted_token) {
 ...
 {"usetable_GRANULE_Nmda_leak_linear", 0, 1},
 {0, 0, 0}
};
 static HocParmUnits _hoc_parm_units[] = {
 {"surf_GRANULE_Nmda_leak_linear", "cm2"},
 {"O_GRANULE_Nmda_leak_linear", "s"},
 {"mgo_GRANULE_Nmda_leak_linear", "mM"},
 {"kmg_GRANULE_Nmda_leak_linear", "mM"},
 {"deltav_GRANULE_Nmda_leak_linear", "mV"},
 {"gmax_GRANULE_Nmda_leak_linear", "mho"},
 {"Erev_GRANULE_Nmda_leak_linear", "mV"},
 {"v0_block_GRANULE_Nmda_leak_linear", "mV"},
 {"k_block_GRANULE_Nmda_leak_linear", "mV"},
 {"fix_celsius_GRANULE_Nmda_leak_linear", "degC"},
 {"i_GRANULE_Nmda_leak_linear", "mA/cm2"},
 {"ic_GRANULE_Nmda_leak_linear", "mA/cm2"},
 {"g_GRANULE_Nmda_leak_linear", "mho/cm2"},
 {0, 0}
};
 /* connect global user variables to hoc */
 static DoubScal hoc_scdoub[] = {
 {"surf_GRANULE_Nmda_leak_linear", &surf_GRANULE_Nmda_leak_linear},
 {"O_GRANULE_Nmda_leak_linear", &O_GRANULE_Nmda_leak_linear},
 {"Or_GRANULE_Nmda_leak_linear", &Or_GRANULE_Nmda_leak_linear},
 {"mgo_GRANULE_Nmda_leak_linear", &mgo_GRANULE_Nmda_leak_linear},
 {"kmg_GRANULE_Nmda_leak_linear", &kmg_GRANULE_Nmda_leak_linear},
 {"deltav_GRANULE_Nmda_leak_linear", &deltav_GRANULE_Nmda_leak_linear},
 {"usetable_GRANULE_Nmda_leak_linear", &usetable_GRANULE_Nmda_leak_linear},
 {0, 0}
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _GRANULE_Nmda_leak_linear_reg() {
	int _vectorized = 1;
  _initlists();
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_prop_size(_mechtype, 14, 0);
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 GRANULE_Nmda_leak_linear /home/oliver/GranularLayerModel/src/mod/GRANULE_Nmda_leak_linear.mod\n");
...
static int rates(_internalthreadargsprotocomma_ double);
 ...
 static double _mfac_rates, _tmin_rates;
  ...
  double _xi, _tmax;
  static double _sav_mgo;
  static double _sav_kmg;
  static double _sav_deltav;
  if (!usetable) {return;}
  if (_sav_mgo != mgo) { _maktable = 1;}
  if (_sav_kmg != kmg) { _maktable = 1;}
  if (_sav_deltav != deltav) { _maktable = 1;}
...
static int  _f_rates ( _internalthreadargsprotocomma_ double _lv ) {
   MgBlock = 1.0 / ( 1.0 + ( mgo / kmg ) * exp ( - _lv / deltav ) ) ;
    return 0; }
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_GRANULE_Nmda_leak_linear. Requires prior call to setdata_GRANULE_Nmda_leak_linear and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/oliver/GranularLayerModel/src/mod/GRANULE_Nmda_leak_linear.mod";
  ...
  "\n"
  "NEURON {\n"
  "	SUFFIX GRANULE_Nmda_leak_linear\n"
