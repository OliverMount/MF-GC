...
#define Q10_diff _ml->template fpfield<8>(_iml)
#define Q10_diff_columnindex 8
#define Q10_channel _ml->template fpfield<9>(_iml)
#define Q10_channel_columnindex 9
#define gbar _ml->template fpfield<10>(_iml)
#define gbar_columnindex 10
#define fix_celsius _ml->template fpfield<11>(_iml)
#define fix_celsius_columnindex 11
#define ic _ml->template fpfield<12>(_iml)
#define ic_columnindex 12
#define n_inf _ml->template fpfield<13>(_iml)
#define n_inf_columnindex 13
#define tau_n _ml->template fpfield<14>(_iml)
#define tau_n_columnindex 14
#define g _ml->template fpfield<15>(_iml)
#define g_columnindex 15
#define gbar_Q10 _ml->template fpfield<16>(_iml)
#define gbar_Q10_columnindex 16
#define n _ml->template fpfield<17>(_iml)
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 4, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 23);
 	...
 	Aalpha_n = _parm_default[0]; /* 0.0033 */
 	Kalpha_n = _parm_default[1]; /* 40 */
 	V0alpha_n = _parm_default[2]; /* -30 */
 	Abeta_n = _parm_default[3]; /* 0.0033 */
 	Kbeta_n = _parm_default[4]; /* -20 */
 	V0beta_n = _parm_default[5]; /* -30 */
 	V0_ninf = _parm_default[6]; /* -30 */
 	B_ninf = _parm_default[7]; /* 6 */
 	Q10_diff = _parm_default[8]; /* 1.5 */
 	Q10_channel = _parm_default[9]; /* 3 */
 	gbar = _parm_default[10]; /* 0.00025 */
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"Q10_diff"} /* 8 */,
                                       _nrn_mechanism_field<double>{"Q10_channel"} /* 9 */,
                                       _nrn_mechanism_field<double>{"gbar"} /* 10 */,
                                       _nrn_mechanism_field<double>{"fix_celsius"} /* 11 */,
                                       _nrn_mechanism_field<double>{"ic"} /* 12 */,
                                       _nrn_mechanism_field<double>{"n_inf"} /* 13 */,
                                       _nrn_mechanism_field<double>{"tau_n"} /* 14 */,
                                       _nrn_mechanism_field<double>{"g"} /* 15 */,
                                       _nrn_mechanism_field<double>{"gbar_Q10"} /* 16 */,
                                       _nrn_mechanism_field<double>{"n"} /* 17 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 GRANULE_KM /home/oliver/GranularLayerModel/src/mod/GRANULE_KM.mod\n");
...
double alp_n ( _internalthreadargsprotocomma_ double _lv ) {
   double _lalp_n;
 double _lQ10 ;
 _lQ10 = pow( Q10_channel , ( ( fix_celsius - 22.0 ) / 10.0 ) ) ;
...
static void _hoc_alp_n(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for alp_n_GRANULE_KM. Requires prior call to setdata_GRANULE_KM and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void _hoc_bet_n(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for bet_n_GRANULE_KM. Requires prior call to setdata_GRANULE_KM and that the specified mechanism instance still be in existence.", NULL);
  }
  Prop* _local_prop = _extcall_prop;
  _nrn_mechanism_cache_instance _ml_real{_local_prop};
auto* const _ml = &_ml_real;
...
static void _hoc_rate(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rate_GRANULE_KM. Requires prior call to setdata_GRANULE_KM and that the specified mechanism instance still be in existence.", NULL);
  }
  Prop* _local_prop = _extcall_prop;
  _nrn_mechanism_cache_instance _ml_real{_local_prop};
auto* const _ml = &_ml_real;
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/oliver/GranularLayerModel/src/mod/GRANULE_KM.mod";
  ...
  "	Q10 = Q10_channel^((fix_celsius-22(degC))/10(degC))\n"
  ...
  "	       Abeta_n, Kbeta_n, V0beta_n, V0_ninf, B_ninf, fix_celsius FROM -100 TO 30 WITH 13000\n"
  "	a_n = alp_n(v)\n"
  "	b_n = bet_n(v)\n"
  "	tau_n = 1/(a_n + b_n)\n"
  ":	n_inf = a_n/(a_n + b_n)\n"
