...
class IN1(IN):
    def __init__(self, bias_current):
        ...
        # self.gap_dend_order = [4, 6, 8, 10, 5, 7, 9, 11]
        # self.spray_synapses()

    # def spray_gap_junctions(self, i=0, g=170e-6):
    #     if i == 0:
    #         n = np.random.randint(4, 12)
    #         # n = self.gap_dend_order[len(self.gap_list)]
    #     else:
    #         n = i
    #     self.gap_list.append(h.gapp(self.dend[n](0.5)))
    #     self.gap_list[-1].g = g
